...
This project provided valuable hands-on experience in Practical application of microwave engineering principles, Understanding of antenna parameters and their optimization, Implementation of cost-effective fabrication techniques, Testing and measurement using Vector Network Analyzer (VNA), Problem-solving in resource-constrained environments and Team collaboration and project management. We have published all the design files including the Footprints and results in a GitHub Repo: https://github.com/Git-Kavinda/2.4GHZ_Patch_Antenna_Design.
